...
mytextclock = awful.widget.textclock(" <span font='Terminus 12'> <span font='Terminus 10' color='#FFFFFF'>" .. date_format .. " " .. time_format .. "</span> </span>", 1)
...
memwidget = lain.widgets.mem({
    settings = function()
        widget:set_markup("<span font='Terminus 12'> <span font='Terminus 9'>" .. mem_now.used .. "MB </span></span>")
    end
})
...
cpuwidget = wibox.widget.background(lain.widgets.cpu({
    settings = function()
        widget:set_markup("<span font='Terminus 12'> <span font='Terminus 9'>" .. cpu_now.usage .. "% </span></span>")
    end
}), "#313131")
...
tempwidget = lain.widgets.temp({
    settings = function()
        widget:set_markup("<span font='Terminus 12'> <span font='Terminus 9'>" .. coretemp_now .. "°C </span></span>")
    end
})
...
fswidget = lain.widgets.fs({
    settings  = function()
        widget:set_markup("<span font='Terminus 12'> <span font='Terminus 9'>" .. fs_now.used .. "% </span></span>")
    end
})
...
batwidget = lain.widgets.bat({
    settings = function()
        ...
        widget:set_markup("<span font='Terminus 12'> <span font='Terminus 9'>" .. bat_now.perc .. "% </span></span>")
    end
})
...
volumewidget = lain.widgets.alsa({
    settings = function()
        ...
        widget:set_markup("<span font='Terminus 12'> <span font='Terminus 9'>" .. volume_now.level .. "% </span></span>")
    end
})
